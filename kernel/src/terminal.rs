...
impl TerminalState {
    ...
    fn max_scroll(&self) -> usize {
        ...
        self.visual_line_count()
            .saturating_add(self.extra_lines)
    ...
    fn set_view_with_extra(&mut self, rows: usize, cols: usize, extra_lines: usize) {
        self.view_rows = rows;
        self.view_cols = cols;
    ...
    fn set_view(&mut self, rows: usize, cols: usize) {
        self.set_view_with_extra(rows, cols, 0);
    }
...
pub fn set_view_with_extra(rows: usize, cols: usize, extra_lines: usize) {
    with_state_mut(|term| term.set_view_with_extra(rows, cols, extra_lines));
}

#[allow(dead_code)]
pub fn set_view_rows(rows: usize) {
    with_state_mut(|term| term.set_view_with_extra(rows, term.view_cols, term.extra_lines));
}
...
pub fn max_scroll() -> usize {
    with_state(|term| term.max_scroll())
}
