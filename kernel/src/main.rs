...
pub const OS_VERSION: &str = "4.A031.wow.250117.EXENUS@cfc8a";
...
const BOOT_MODE: BootMode = BootMode::Desktop;
...
fn kernel_main(boot_info: &'static mut BootInfo) -> ! {
    ...
    let hud_rows = if matches!(BOOT_MODE, BootMode::Console) { 1 } else { 0 };
    ...
    match BOOT_MODE {
        BootMode::Console => run_console_shell(),
        BootMode::Desktop => {
